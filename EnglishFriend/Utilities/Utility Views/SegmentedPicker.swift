...
struct SegmentedPicker: View {
    ...
    private static let SegmentCornerRadius: CGFloat = 6
    ...
    private static let PickerPadding: CGFloat = 6
    ...
    private var activeSegmentView: AnyView {
        ...
        return
            ...
            .shadow(color: SegmentedPicker.ShadowColor, radius: SegmentedPicker.ShadowRadius, x:2, y:2)
    ...
    private func getSegmentView(for index: Int) -> some View {
        ...
        return
            Text(isSelected ? "\(index)" : "•").font(.caption2)
